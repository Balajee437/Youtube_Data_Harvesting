...
st.header(':violet[Data Mining]')

st.info("Enter channel Id")

channel_id = st.text_input('Enter channel Id')

Get_data = st.button("Start Mining")
...
st.header(':violet[Data Transfer]')
...
Migrate = st.button('Data Transfer')
